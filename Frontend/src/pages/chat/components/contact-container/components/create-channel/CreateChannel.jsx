...
import MultipleSelector from "@/components/ui/multiple-selector";
  ...
  export const CreateChannel = () => {
    ...
    useEffect(() => {
        const getData = async() => {
            const response = await axios.get(`${api_url}/api/contacts/get-all-contacts`, {withCredentials:true})
    ...
    const CreateChannel = async() => {
        try {
            const response = await axios.post(`${api_url}/api/channel/create-channel`,{
                name:channelName,
